    ...
    return (
        <div className={styles.main_wrap}>
                            ...
                            >
                                ...
                                <Box padding="top">
                                    ...
                                    <p>
                                        ...
                                        and style for property owners across the
                                        country. Our experts combine form and
                                        function in bringing your vision to
                                        life. Create a room in your own style
                                        with our collection and make your
                                        property a reflection of you and what
                                        you love.
                                    </p>
            ...
            <header className={styles.header}>
                ...
                />
                <nav
                    className={`${open ? styles.mobile_menu : null} ${
                        styles.menu_n
                    }`}
                >
                    <a href="*"> home</a>
